...
def recognize_face():
    try:
        ...
        # Simple face recognition - return first registered student
        cursor = students_collection.find({'school_id': 'S1', 'face_registered': True}).limit(1)
...
def register_face():
    try:
        ...
        # Simple face registration - just mark as registered
...
if __name__ == '__main__':
    print("Starting Siksha Attend with OpenCV face detection...")
